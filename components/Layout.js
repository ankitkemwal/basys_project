...
export default function Layout({children}) {
  ...
  return (
    <div className="h-screen bg-[#d3dcf1] px-4 py-2 overflow-hidden flex">
      ...
      <div className="hidden md:flex md:flex-shrink-0 bg-white rounded-md">
      ...
      <div className="flex-1 p-8 mx-auto w-0 flex flex-col">
        <div className="relative z-10 flex-shrink-0 h-16 flex">
          ...
          <div className="flex-1 flex justify-between px-4 md:px-0 items-center">
            <div className="font-bold text-3xl">Welcome Bayer!</div>
